...
class Kelola_Perpuluhan extends CI_Controller {
	...
	{
        $data['data']=$this->M_Gereja_Persembahan->DataList($this->session->userdata('gereja_id'),'Perpuluhan');
		$data['NamaPepantan'] = $this->M_Gereja_Persembahan->GetNamaPepantan($this->session->userdata('gereja_id'));
		$this->load->view('template/header');
        $this->load->view('template/menu');
		$this->load->view('userGereja/Perpuluhan', $data);
    ...
    {
        $typeName = 'Perpuluhan';
        $Sumber_persembahan = 'Jemaat';
        $data = array (
            "Jumlah" => $this->input->post('jumlah'),
            "DateCreated" => $this->input->post('datecreated'),
            "Sumber_persembahan" =>$Sumber_persembahan,
        ...
        redirect('AdminGereja/Kelola_Perpuluhan');
    }
