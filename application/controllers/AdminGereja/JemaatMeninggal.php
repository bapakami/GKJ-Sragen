...
class JemaatMeninggal extends CI_Controller {
    ...
    {
        $data['data']=$this->M_Jemaat_Gereja->DataListMeninggal($this->session->userdata('gereja_id'));
        ...
        $this->load->view('userGereja/DataJemaatMeninggal',$data);
    ...
    public function insertData()
    {
        ...
        redirect('AdminGereja/JemaatMeninggal');
    }
