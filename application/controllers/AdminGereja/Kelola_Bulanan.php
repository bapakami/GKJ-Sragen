...
class Kelola_Bulanan extends CI_Controller {
	...
	{
        $data['data']=$this->M_Gereja_Persembahan->DataList($this->session->userdata('gereja_id'),'Bulanan');
		$data['NamaPepantan'] = $this->M_Gereja_Persembahan->GetNamaPepantan($this->session->userdata('gereja_id'));
		$this->load->view('template/header');
        $this->load->view('template/menu');
		$this->load->view('userGereja/Bulanan', $data);
	...
	public function insertData()
    {
        ...
        redirect('AdminGereja/Kelola_Bulanan');
    }
