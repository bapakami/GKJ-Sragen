                ...
                <form class="needs-validation" novalidate>
                    <div class="row">
                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-6 ">
                            ...
                            <input type="text" class="form-control" id="validationCustom01" name="namadepan" placeholder="Nama Depan" required>
                        ...
                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-6 ">
                            ...
                            <input type="text" class="form-control" id="validationCustom02" name="namabelakang" placeholder="Nama Belakang"required>
                            <div class="valid-feedback">
                                Looks good!
                            </div>
                        </div>
                        ...
                        <div class="col-xl-4 col-lg-4 col-md-4 col-sm-4 col-4">
                            ...
                            <div class="custom-file mb-3">
                                <input type="file" class="custom-file-input" id="customFile" name="passfoto">
