    ...
    <section class="content-header">
        ...
        <small></small>
      	...
      	<ol class="breadcrumb">
        	...
        	<li class="active">Grafik Keluarga </li>
      	</ol>
    </section>
...
<script>
	var columnKeluarga = <?= json_encode($columnKeluarga) ?>;
...
window.onload = function() {
	...
	$.ajax({
		type: "GET",
		url: base_url + "Graph/Keluarga/data",
		data: {
		...
		success: function(res){
			...
			chart = new CanvasJS.Chart("chartContainer", {
				...
				title: {
					text: "Grafik Keluarga Jemaat Gereja " + res.name
				},
				subtitles:[
				{
					text: res.listGender	
