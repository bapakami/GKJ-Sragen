...
<div class="content-wrapper">
    ...
    <section class="content-header">
      	<h1>
 			Grafik Pekerjaan dan Penghasilan
        <small></small>
      	</h1>
      	<ol class="breadcrumb">
        	<li><a href="#"><i class="fa fa-briefcase"></i> Fasilitas </a></li>
        	<li class="active">Grafik Pekerjaan dan Penghasilan </li>
      	</ol>
    </section>
...
<script>
	var columnPenghasilan = <?= json_encode($columnPenghasilan) ?>;
	var gereja = <?= json_encode($gereja) ?>;
	var columnPekerjaan = <?= json_encode($columnPekerjaan) ?>;
</script>
...
window.onload = function() {
	...
	$.ajax({
		type: "GET",
		url: base_url + "Graph/PekerjaanPenghasilan/data",
		data: {
		...
		success: function(res){
			...
			chart = new CanvasJS.Chart("chartContainer", {
				...
				title: {
					text: "Grafik Pekerjaan dan Penghasilan Jemaat Gereja " + res.name
				},
				subtitles:[
				{
					text: "Penghasilan : " + res.listPenghasilan	
				}
				],
				data: [{
					type: "pie",
