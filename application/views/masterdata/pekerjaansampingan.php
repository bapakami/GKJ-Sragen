  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Pekerjaan Sampingan </li>
      </ol>
    </section>
            ...
            <div class="box-body table-responsive">
              <table id="example1" class="table table-striped table-bordered table-responsive" style="width:100%;font-size:13px;">
                ...
                <tr>
                  ...
                  <th style="width: 300px">Pekerjaan Sampingan</th>
  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      <div class="modal-header modal-header-success">
        ...
        <h3>Edit Pekerjaan Sampingan</h3>
      </div>
      <form class="form-horizontal" action="<?php echo base_url('Pekerjaansampingan/editData')?>" method="post" enctype="multipart/form-data" role="form">
          ...
          <div class="col-md-6">
            <div class="form-group">
              <div class="input-group col-md-10">
                <label for="nama_ps">Pekerjaan Sampingan</label>
                <input id="nama_ps" type="text" name="nama_ps" class="form-control" value="<?=$nama_ps;?>" placeholder="Masukkan Pekerjaan Sampingan.." required="required" data-error="Side Job is required.">
              </div>
            </div>
          </div>
          <div class="col-md-6">
            <div class="form-group">
              <div class="input-group col-md-10">
                ...
                <input id="deskripsi" type="text" name="deskripsi" class="form-control" value="<?=$deskripsi;?>" placeholder="Masukkan Deskripsi Pekerjaan Sampingan.." required="required" data-error="The description of side job is required.">
              </div>
            </div>
          </div>
          <!-- </div> -->
...
<div class="modal fade" id="hapus_data<?= $idx; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
 <div class="modal-dialog">
   <div class="modal-content" style="width: 440px">
     ...
     <form class="form-horizontal" action="<?php echo base_url('Pekerjaansampingan/hapusData')?>" method="post" enctype="multipart/form-data" role="form">
...
<div class="modal fade" id="tambah_data" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                <div class="modal-dialog modal-lg">
                    <div class="modal-content">
                        <div class="modal-header modal-header-success">
                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                            <h3>Tambah Pekerjaan Sampingan</h3>
                        </div>
                    <form class="form-horizontal" action="<?php echo base_url('Pekerjaansampingan/insertData')?>" method="post" enctype="multipart/form-data" role="form">
                        <div class="modal-body">
                <!-- <div class="row"> -->
                    <div class="col-md-6">
                        <div class="form-group">
                            <div class="input-group col-md-10">
                            <label for="nama_ps">Pekerjaan Sampingan</label>
                            <input id="nama_ps" type="text" name="nama_ps" class="form-control" placeholder="Masukkan Pekerjaan Sampingan.." required="required" data-error="Side Job is required.">
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            <div class="input-group col-md-10">
                            <label for="deskripsi">Deskripsi</label>
                            <input id="deskripsi" type="text" name="deskripsi" class="form-control" placeholder="Masukkan Deskripsi Pekerjaan Sampingan.." required="required" data-error="The description of side job is required.">
                            </div>
                        </div>
                    </div>
                <!-- </div> -->
