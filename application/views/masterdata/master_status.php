...
<div class="modal fade" id="edit_data<?= $idx; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      ...
      <form class="form-horizontal" action="<?php echo base_url('master_status/editData')?>" method="post" enctype="multipart/form-data" role="form">
          ...
          <div class="col-md-6">
            <div class="form-group">
              <div class="input-group col-md-10">
                ...
                <input id="status" type="text" name="status" class="form-control" value="<?=$status;?>" placeholder="Masukkan Status Pernikahan.." required="required" data-error="Status is required.">
              </div>
            </div>
          </div>
          <!-- </div> -->
...
<div class="modal fade" id="hapus_data<?= $idx; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
 <div class="modal-dialog">
   <div class="modal-content" style="width: 440px">
     ...
     <form class="form-horizontal" action="<?php echo base_url('Master_status/hapusData')?>" method="post" enctype="multipart/form-data" role="form">
...
<div class="modal fade" id="tambah_data" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                <div class="modal-dialog modal-lg">
                    ...
                    <form class="form-horizontal" action="<?php echo base_url('Master_status/insertData')?>" method="post" enctype="multipart/form-data" role="form">
                        <div class="modal-body">
                <!-- <div class="row"> -->
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input id="status" type="text" name="status" class="form-control" placeholder="Masukkan Pendidikan Terakhir.." required="required" data-error="Education is required.">
                            </div>
                        </div>
                    </div>
                <!-- </div> -->
