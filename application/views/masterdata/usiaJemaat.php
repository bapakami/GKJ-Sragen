  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      <div class="modal-header modal-header-success">
        ...
        <h3>Edit Usia Jemaat</h3>
      </div>
      <form class="form-horizontal" action="<?php echo base_url('DataUsia/editData')?>" method="post" enctype="multipart/form-data" role="form">
          ...
          <div class="col-md-6">
            <div class="form-group">
              <div class="input-group col-md-10">
                <label for="usia">Usia Jemaat</label>
                <input id="usia" type="text" name="usia" class="form-control" value="<?=$usia;?>" placeholder="Masukkan Minat Pelayanan Gereja.." required="required" data-error="Interest in Church Service is required.">
              </div>
            </div>
          </div>
          <div class="col-md-6">
 ...
 <div class="modal-dialog">
   <div class="modal-content" style="width: 440px">
     <div class="modal-header modal-header-success">
       ...
       <h3>Hapus Data Jemaat</h3>
     </div>
     <form class="form-horizontal" action="<?php echo base_url('DataUsia/hapusData')?>" method="post" enctype="multipart/form-data" role="form">
...
<div class="modal fade" id="tambah_data" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                <div class="modal-dialog modal-lg">
                    ...
                    <form class="form-horizontal" action="<?php echo base_url('DataUsia/insertData')?>" method="post" enctype="multipart/form-data" role="form">
                        <div class="modal-body">
                <!-- <div class="row"> -->
                    <div class="col-md-6">
                        <div class="form-group">
                            <div class="input-group col-md-10">
                            <label for="usia">Usia Jemaat</label>
                            <input id="usia" type="text" name="usia" class="form-control" placeholder="Masukkan Minat Pelayanan Gereja.." required="required" data-error="Interest in Church Service is required.">
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6">
