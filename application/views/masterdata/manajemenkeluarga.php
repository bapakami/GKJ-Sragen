  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Data Master Status Keluarga </li>
      </ol>
    </section>
            ...
            <div class="box-body table-responsive">
              <table id="example1" class="table table-striped table-bordered table-responsive" style="width:100%;font-size:13px;">
                ...
                <tr>
                  ...
                  <th style="width: 300px">Nama Status Keluarga</th>
                        ...
                        <?php
                            $no = 0;
                             foreach ($data->result_array() as $i) :
                                    $no++;
                                    $idx = $i['Idx'];
                                    $nama_sk = $i['Nama_Status_Keluarga'];
                                    $deskripsi = $i['Desc'];
                         ?>
                <tr>
  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      <div class="modal-header modal-header-success">
        ...
        <h3>Edit Master Status Keluarga</h3>
      </div>
      <form class="form-horizontal" action="<?php echo base_url('MasterStatusKeluarga/editData')?>" method="post" enctype="multipart/form-data" role="form">
          ...
          <div class="col-md-6">
            <div class="form-group">
              <div class="input-group col-md-10">
                <label for="nama_sk">Nama Status Keluarga</label>
                <input id="nama_pg" type="text" name="nama_sk" class="form-control" value="<?=$nama_sk;?>" placeholder="Masukkan Nama Status Keluarga" required="required" data-error="Interest in Church Service is required.">
              </div>
            </div>
          </div>
          <div class="col-md-6">
            <div class="form-group">
              <div class="input-group col-md-10">
                ...
                <input id="deskripsi" type="text" name="deskripsi" class="form-control" value="<?=$deskripsi;?>" placeholder="Masukkan Deskripsi Status Keluarga" data-error="The description of interest in church service is required.">
              </div>
            </div>
          </div>
          <!-- </div> -->
...
<div class="modal fade" id="hapus_data<?= $idx; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
 <div class="modal-dialog">
   <div class="modal-content" style="width: 440px">
     ...
     <form class="form-horizontal" action="<?php echo base_url('MasterStatusKeluarga/hapusData')?>" method="post" enctype="multipart/form-data" role="form">
...
<div class="modal fade" id="tambah_data" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                <div class="modal-dialog modal-lg">
                    <div class="modal-content">
                        <div class="modal-header modal-header-success">
                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                            <h3>Tambah Master Status Keluarga</h3>
                        </div>
                    <form class="form-horizontal" action="<?php echo base_url('MasterStatusKeluarga/insertData')?>" method="post" enctype="multipart/form-data" role="form">
                        <div class="modal-body">
                <!-- <div class="row"> -->
                    <div class="col-md-6">
                        <div class="form-group">
                            <div class="input-group col-md-10">
                            <label for="nama_sk">Nama Status Keluarga</label>
                            <input id="nama_sk" type="text" name="nama_sk" class="form-control" placeholder="Masukkan Nama Status Keluarga" required="required">
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            <div class="input-group col-md-10">
                            <label for="deskripsi">Deskripsi</label>
                            <input id="deskripsi" type="text" name="deskripsi" class="form-control" placeholder="Masukkan Deskripsi Status Keluarga">
                            </div>
                        </div>
                    </div>
                <!-- </div> -->
