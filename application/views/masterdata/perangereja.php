  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Data Peran dalam Gereja
        <small></small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-briefcase"></i> Master Data </a></li>
        <li class="active">Peran dalam Gereja </li>
      </ol>
    </section>
            ...
            <div class="box-body table-responsive">
              <table id="example1" class="table table-striped table-bordered table-responsive" style="width:100%;font-size:13px;">
                ...
                <tr>
                  ...
                  <th style="width: 300px">Nama Peran</th>
  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      <div class="modal-header modal-header-success">
        ...
        <h3>Edit Peran dalam Gereja</h3>
      </div>
      <form class="form-horizontal" action="<?php echo base_url('Perangereja/editData')?>" method="post" enctype="multipart/form-data" role="form">
          ...
          <div class="col-md-6">
            <div class="form-group">
              <div class="input-group col-md-10">
                ...
                <input id="nama_peran" type="text" name="nama_peran" class="form-control" value="<?=$nama_peran;?>" placeholder="Masukkan Peran dalam Gereja.." required="required" data-error="Role in The Church is required.">
              </div>
            </div>
          </div>
          <div class="col-md-6">
            <div class="form-group">
              <div class="input-group col-md-10">
                ...
                <input id="deskripsi" type="text" name="deskripsi" class="form-control" value="<?=$deskripsi;?>" placeholder="Masukkan Deskripsi Peran dalam Gereja.." required="required" data-error="The description of role in the church is required.">
              </div>
            </div>
          </div>
          <!-- </div> -->
...
<div class="modal fade" id="hapus_data<?= $idx; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
 <div class="modal-dialog">
   <div class="modal-content" style="width: 440px">
     ...
     <form class="form-horizontal" action="<?php echo base_url('Perangereja/hapusData')?>" method="post" enctype="multipart/form-data" role="form">
...
<div class="modal fade" id="tambah_data" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                <div class="modal-dialog modal-lg">
                    <div class="modal-content">
                        <div class="modal-header modal-header-success">
                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                            <h3>Tambah Peran dalam Gereja</h3>
                        </div>
                    <form class="form-horizontal" action="<?php echo base_url('Perangereja/insertData')?>" method="post" enctype="multipart/form-data" role="form">
                        <div class="modal-body">
                <!-- <div class="row"> -->
                    <div class="col-md-6">
                        <div class="form-group">
                            <div class="input-group col-md-10">
                            <label for="nama_peran">Nama Peran</label>
                            <input id="nama_peran" type="text" name="nama_peran" class="form-control" placeholder="Masukkan Peran dalam Gereja.." required="required" data-error="Role in The Church is required.">
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            <div class="input-group col-md-10">
                            <label for="deskripsi">Deskripsi</label>
                            <input id="deskripsi" type="text" name="deskripsi" class="form-control" placeholder="Masukkan Deskripsi Peran dalam Gereja.." required="required" data-error="The description of role in the church is required.">
                            </div>
                        </div>
                    </div>
                <!-- </div> -->
