  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Manajemen Data Non Jemaat
        <small></small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-briefcase"></i> Fasilitas </a></li>
        <li class="active">Manajemen Data Non Jemaat </li>
      </ol>
    </section>
                ...
                <tr>
                    ...
                    <td style="text-align:center;"> 
                        <span data-toggle="tooltip" data-placement="top" data-original-title="Lihat Detail ">
                          <a href="<?php echo base_url().'AdminGereja/NonJemaat/detail/'.$id; ?>">
                        ...
                        <span data-toggle="tooltip" data-placement="top" data-original-title="Edit ">
                          <a href="<?php echo base_url().'AdminGereja/NonJemaat/FormEditJemaat/'.$id; ?>">
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title" id="myModalLabel">Hapus Data Non Jemaat</h4>
                    </div>
                    <form class="form-horizontal" action="<?php echo base_url().'AdminGereja/NonJemaat/hapusData'; ?>" method="post" enctype="multipart/form-data">
