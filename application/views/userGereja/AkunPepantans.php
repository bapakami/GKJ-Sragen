  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Manajemen Pepantans <?= $NamaGereja?>
        <small></small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-briefcase"></i> Fasilitas </a></li>
        <li class="active">Manajemen Pepantans </li>
      </ol>
    </section>
...
<div class="modal fade" id="edit_data<?php echo $id; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        ...
        <form class="form-horizontal" action="<?php echo base_url('AdminGereja/ManajemenAkunPepantans/editData')?>" method="post" enctype="multipart/form-data" role="form">
          ...
          <div class="modal-body">
                  ...
                  <div class="input-group col-md-10">
                      <label>User Group</label>
                        <select class='form-control' name="user_group_edit" >
                          <option value='7'>Admin Pepantans</option>   
                        </select>
                  </div>
              </div>
                  <br>
              ...
              <div class="form-group col-md-12">
                  <div class="input-group col-md-5">
                    <label>Asal Pepantans</label>
                    <select class='form-control' id='gereja_edit' name="gereja_edit">
                     <?php if($i['Pepantan_id'] != null) {?>
                      <option value='<?php echo $i['pepantans_id']; ?>'><?php echo $i['namapepantan']; ?></option>
                      <?php } ?>   
                          <?php 
        ...
        <div class="modal fade" id="ModalHapus<?php echo $id; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <form class="form-horizontal" action="<?php echo base_url().'AdminGereja/ManajemenAkunPepantans/hapusData'; ?>" method="post" enctype="multipart/form-data">
                    <div class="modal-body">
...
<div class="modal fade" id="tambah_data" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        ...
        <form class="form-horizontal" onsubmit="return validateForm()" action="<?php echo base_url('AdminGereja/ManajemenAkunPepantans/insertData')?>" method="post" enctype="multipart/form-data" role="form">
            ...
            <div class="form-group">
                <label class="control-label col-md-3 col-sm-3 col-xs-12">Asal Pepanthan</label>
                <div class="col-md-4 col-sm-9 col-xs-12">
