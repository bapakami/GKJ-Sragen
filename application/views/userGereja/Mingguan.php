  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Manajemen Kelola Mingguan
        <small></small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-briefcase"></i> Persembahan </a></li>
        <li class="active">Manajemen Kelola Mingguan </li>
      </ol>
    </section>
...
<div class="modal fade" id="edit_data<?php echo $id; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        ...
        <form class="form-horizontal" action="<?php echo base_url('AdminGereja/Kelola_Mingguan/editData')?>" method="post" enctype="multipart/form-data" role="form">
        ...
        <div class="modal-body">
          <div class="col-md-12">
            ...
            <br>
            <div class="form-group ">
              <label for="middle-name" class="control-label col-md-3 col-sm-3 col-xs-12">Minggu ke</label>
              <div class="col-md-6 col-sm-6 col-xs-12">
              <input name="minggu_edit" id="minggu_edit" type="text" Placeholder="1/2/3/4" value='<?php echo $i['Minggu']; ?>' class="form-control" style="z-index: 2000; width: 400px;" required="required" />
              </div>
            </div>
        ...
        <div class="modal fade" id="ModalHapus<?php echo $id; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <form class="form-horizontal" action="<?php echo base_url().'AdminGereja/Kelola_Mingguan/hapusData'; ?>" method="post" enctype="multipart/form-data">
                    <div class="modal-body">
...
<div class="modal fade" id="tambah_data" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
         ...
         <form class="form-horizontal" onsubmit="return validateForm()" action="<?php echo base_url('AdminGereja/Kelola_Mingguan/insertData')?>" method="post" enctype="multipart/form-data" role="form">
        <div class="modal-body">
          <div class="col-md-12">
            <div class="form-group ">
              <label for="middle-name" class="control-label col-md-3 col-sm-3 col-xs-12">Tanggal</label>
            ...
            <div class="form-group ">
              <label for="middle-name" class="control-label col-md-3 col-sm-3 col-xs-12">Minggu ke</label>
              <div class="col-md-6 col-sm-6 col-xs-12">
              <input name="minggu" id="minggu" type="text" Placeholder="1/2/3/4" class="form-control" style="z-index: 2000; width: 400px;" />
              </div>
            </div>
...
function validateForm() {
    if($('#minggu').val() == ''){
        alert("Mingguan tidak boleh kosong!!");
        return false;
    } else if($('#bulan').val() == ''){
