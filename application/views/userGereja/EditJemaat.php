                  ...
                  <div class="clearfix"></div>
                    ...
                    <div class="">
                      <!-- <div class="x_panel"> -->
                        ...
                        ?>
        <form class="form-horizontal" action="<?php echo base_url('AdminGereja/Jemaat/editData')?>" method="post" enctype="multipart/form-data" role="form">
                        ...
                        <div class="container-fluid">
                          ...
                          <div class="row">
                            <div class="col-md-4">
                              ...
                              <input id="NoInduk_edit" type="text" name="NoInduk_edit" class="form-control" placeholder="Nomor Induk" value="<?= $i['no_induk']?>" required="required">
                            </div>
                          ...
                          <br>
                                ...
                                <div class="row">
                                  <div class="col-md-4">
                                    ...
                                    <input id="NoTelp_edit" type="text" name="NoTelp_edit" class="form-control" placeholder="Nomor Telepon" value="<?= $i['telepon']?>">
                                  </div>
                                  <div class="col-md-4 ml-auto">
