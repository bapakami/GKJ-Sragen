  ...
  <div class="content-wrapper">
   ...
   <section class="content-header">
    <h1>
     Manajemen Jemaat Sidi
     <small></small>
   </h1>
   <ol class="breadcrumb">
     <li><a href="#"><i class="fa fa-briefcase"></i> Fasilitas </a></li>
     <li class="active">Manajemen Jemaat Sidi</li>
   </ol>
 </section>
    ...
    <div class="col-xs-12">
      <div class="box">
                  ...
                  <tr>
                    ...
                    <td style="text-align:center;"> 
                      <span data-toggle="tooltip" data-placement="top" data-original-title="Percakapan">
                        <button class="btn btn-xs"><span> <?php $this->lib->cekChat($id, 3); ?></button>
                        </span> 
              ...
              <div class="modal-body">
                <form id="xyz_<?= $id; ?>" class="form-horizontal" >
                  ...
                  <div class="form-group">
                    ...
                    <input type="hidden" name="tgl_sidhi" value="<?= $i['tgl_sidhi']?>">
        ...
        <script>
          ...
          {
            $('#tampil_form2').load("<?=site_url()?>/pendetaa/chattingan/3/"+id,function(){
          ...
          $('#xyz_'+id).on('submit', (function(e) {
            ...
            $.ajax({
              url: '<?= site_url("Sidi/Sidi/insertData/") ?>',
              type: 'POST',
