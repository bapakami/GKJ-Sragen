...
if ($kat == 1) {
    ...
    $st = $kate['state'];
    if ($st == 1) {
        $marquee = "<marquee behavior='alternate'>Selamat Permohonan Sidi Anda Diterima</marquee>";
        $disabled = 'disabled';
    } elseif ($st == 2) {
        $marquee = "<marquee bgcolor='red'>Mohon Maaf, Permohonan Sidi Anda Ditolak</marquee>";
        $disabled = '';
    } elseif ($st == 3) {
                ...
                <div class="box">
                    <div class="box-body table-responsive">
                        <div class="right_col" role="main">
                            <div class="row" id="formDataBaru">
                                <div class="col-md-12">
                                    <center>
                                        <h3>Pendaftaran Sidi</h3>
                                    </center>
                                    <hr />
                                </div>
                                <input type="hidden" name="reff" id="reff" value="<?= $katekesasi->num_rows();?>">
                                <div class="col-md-4">
...
<script>
    ...
    $(document).ready(function() {
        ...
        if(ready <= 0) {
            ...
            $('#announ').html('<marquee>Anda Belum Melakukan proses katekesasi. Segera daftar katekesasi sebelum melakukan proses daftar sidi</marquee>')
        }
        ...
        $('#daftar').on('click', function(e) {
            ...
            if(state == true) {
                ...
                fd.append('nama', nama);
                $.ajax({
                    url: '<?= site_url("warga/layanan/daftarSidi/") ?>' + id,
                    type: 'post',
                    data: fd,
                    dataType: "json",
                    contentType: false,
