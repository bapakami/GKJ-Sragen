  ...
  <div class="content-wrapper">
   ...
   <section class="content-header">
    <h1>
     Manajemen Jemaat Baptis Dewasa
     <small></small>
   </h1>
   <ol class="breadcrumb">
     <li><a href="#"><i class="fa fa-briefcase"></i> Fasilitas </a></li>
     <li class="active">Manajemen Jemaat Baptis Dewasa</li>
   </ol>
 </section>
    ...
    <div class="col-xs-12">
      <div class="box">
                  ...
                  <tr>
                    ...
                    <td style="text-align:center;"> 
                      <span data-toggle="tooltip" data-placement="top" data-original-title="Percakapan">
                        <button class="btn btn-xs"><span> <?php $this->lib->cekChat($id, 2); ?></button>
                        </span> 
            ...
            <div class="modal-dialog modal-lg">              
             <div class="modal-content">
              <div class="modal-header modal-header-success">
                ...
                <h3>Tinjau berkas Baptis Dewasa</h3>
              </div>
              <div class="modal-body">
                <form id="xyz_<?= $id; ?>" class="form-horizontal" >
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-10">: <?php echo $i['tanggal_lahir'];?></div>
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    <div class="col-md-2">Saksi 1</div>
                    <div class="col-md-10">: <?php echo $i['saksi1'];?></div>
                  </div>
                  <div class="form-group">
                    <div class="col-md-2">Saksi 2</div>
                    <div class="col-md-10">: <?php echo $i['saksi2'];?></div>
                    <input type="hidden" name="tgl_daftar" value="<?= $i['tgl_daftar']?>">
        ...
        <script>
          ...
          {
            $('#tampil_form2').load("<?=site_url()?>/pendetaa/chattingan/2/"+id,function(){
          ...
          $('#xyz_'+id).on('submit', (function(e) {
            ...
            $.ajax({
              url: '<?= site_url("Baptis/Baptisdewasa/insertData/") ?>',
              type: 'POST',
