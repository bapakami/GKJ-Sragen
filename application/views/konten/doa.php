  ...
  <div class="content-wrapper">
   ...
   <section class="content-header">
    <h1>
     Manajemen Jemaat Layanan Doa
     <small></small>
   </h1>
   <ol class="breadcrumb">
     <li><a href="#"><i class="fa fa-briefcase"></i> Fasilitas </a></li>
     <li class="active">Manajemen Jemaat Layanan Doa</li>
   </ol>
 </section>
  ...
  <div class="row">
    <div class="col-xs-12">
                  ...
                  <tr>
                    ...
                    <td style="text-align:center;"> 
                      <span data-toggle="tooltip" data-placement="top" data-original-title="Percakapan">
                        <button class="btn btn-xs"><span> <?php $this->lib->cekChat($id, 6); ?></button>
                        </span> 
          ...
          <div class="modal-dialog modal-lg">              
           <div class="modal-content">
            <div class="modal-header modal-header-success">
              ...
              <h3>Tinjau berkas Layanan Doa</h3>
            </div>
            <div class="modal-body">
              <form id="xyz_<?= $id ?>" class="form-horizontal" >
                ...
                <div class="form-group">
                  <div class="col-md-2"><label>Pelayan 1</label></div>
                  <div class="col-md-10"><input type="text" required name="pelayan1" class="form-control" placeholder="Isikan Pelayan 1"></div>                  
                </div>
                <div class="form-group">
                  <div class="col-md-2"><label>Pelayan 2</label></div>
                  <div class="col-md-10"><input type="text" name="pelayan2" class="form-control" placeholder="Isikan Pelayan 2"></div>                  
                </div>
                <div class="form-group">
      ...
      <script>
          ...
          {
            $('#tampil_form2').load("<?=site_url()?>/pendetaa/chattingan/6/"+id,function(){
        ...
        $('#xyz_'+id).on('submit', (function(e) {
          ...
          $.ajax({
            url: '<?= site_url("Doa/Doa/insertData/") ?>',
            type: 'POST',
