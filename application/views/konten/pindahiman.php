    ...
    <section class="content">
      <div class="row">
                ...
                <tbody>
                  ...
                  foreach ($data->result_array() as $i) :
                    ...
                    <tr>
                      ...
                      <td><?php $this->lib->nama_iman($i['id_iman_lama']);  ?></td>
                      <td><?php echo $i['alasan']; ?></td>
                      <td style="text-align:center;"> 
                      <span data-toggle="tooltip" data-placement="top" data-original-title="Percakapan">
                        <button class="btn btn-xs"><span> <?php $this->lib->cekChat($id, 8); ?></button>
                        </span> 
            ...
            <div class="modal-dialog modal-lg">              
             <div class="modal-content">
              <div class="modal-header modal-header-success">
                ...
                <h3>Tinjau berkas Pindah Iman</h3>
              </div>
                ...
                <form id="xyz_<?= $i['id_jemaat'] ?>" class="form-horizontal" >
                  ...
                  <div class="form-group">
                    <!-- <div class="col-md-3">
                      ...
                      <img src="<?= base_url().$i['pindah_iman']?>" alt="foto" width="150">
                    </div> -->
                    <div class="col-md-3">
                  ...
                  <div class="form-group">
                    <div class="col-md-2">Agama Asal</div>
                    <div class="col-md-10">: <?php $this->lib->nama_iman($i['id_iman_lama']);?></div>
                  </div>
                  <div class="form-group">
                    <div class="col-md-2">Agama Baru</div>
                    <div class="col-md-10">: <?php $this->lib->nama_iman($i['id_iman_baru']);?></div>
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    <div class="col-md-2">Alasan Pindah Iman</div>
                    <div class="col-md-10">: <?= str_replace('<p>', '', $i['alasan'])?></div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                      ...
                      <input type="hidden" name="id_iman" value="<?= $i['id_iman_baru']; ?>">
                    </div>
                    <div class="form-group">
        ...
        <script>
          ...
          {
            $('#tampil_form2').load("<?=site_url()?>/pendetaa/chattingan/8/"+id,function(){
          ...
          $('#xyz_'+ id).on('submit', (function(e) {
            ...
            $.ajax({
              url: '<?= site_url("Pindahiman/Pindahiman/insertData/") ?>',
              type: 'POST',
