...
<head>
  ...
  <link href="<?php echo base_url(); ?>https://fonts.googleapis.com/css?family=Work+Sans:100,200,300,400,500,600,700,800" rel="stylesheet">
  <link rel="shortcut icon" type="image/x-icon" href="<?php echo base_url(); ?><?php echo base_url(); ?>assets/img/logoGKJ.png">
...
<body>
  ...
  <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
    <div class="container">
      <a class="navbar-brand" href="<?php echo base_url(); ?>index.html">
        <!-- <i class="flaticon-cross"></i> --><img src="<?php echo base_url(); ?>assets/wisdom/images/logoGKJ.png" height="30" width="30"> <span>GKJ Klasis</span> <span>Gunung Kidul</span></a>
  ...
  <section id="home" class="video-hero js-fullheight" style="height: 700px; background-image: url(assets/wisdom/images/bg_1.jpg);  background-size:cover; background-position: center center;background-attachment:fixed;" data-section="home">
            ...
            <div class="col-md-12 d-md-flex">
              <div class="one-forth ftco-animate">
                ...
                <p>
                  ...
                  </script> All rights reserved | GKJ Klasis Gunung Kidul <i class="icon-heart" aria-hidden="true"></i> by <a href="https://colorlib.com" target="_blank">SLS</a>
                  <!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
                </p>
              </div>
        ...
        <div class="row mb-5">
          <div class="col-md">
            <div class="ftco-footer-widget mb-4">
              <h2 class="logo"><img src="<?php echo base_url(); ?>assets/wisdom/images/logoGKJ.png" height="30" width="30"> <a href="<?php echo base_url(); ?>index.html"></i><span>GKJ Klasis</span><span>GunungKidul</span></a></h2>

              <br>
                <p>
  Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | This template is made with <i class="icon-heart" aria-hidden="true"></i> by <a href="<?php echo base_url(); ?>https://colorlib.com" target="_blank">Colorlib</a>
\</p>
            </div>
          </div>
        </div>
