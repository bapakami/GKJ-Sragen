        ...
        <div class="modal fade" id="ModalHapus<?php echo $id; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <form class="form-horizontal" action="<?php echo base_url().'Manajemenakun/hapusData'; ?>" method="post" enctype="multipart/form-data">
                    <div class="modal-body">
...
<div class="modal fade" id="tambah_data" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        ...
        <form class="form-horizontal" onsubmit="return validateForm()" action="<?php echo base_url('Manajemenakun/insertData')?>" method="post" enctype="multipart/form-data" role="form">
